...
//Bug if a user is in afk and joins a normal vc and then leaves then they will get afk time as well :P

//Import libraries:
const config = require('./settings.json');
const embed  = require('./embed.js');

//Remember u need npm i opusscript to play sounds!
...
//Arrays
const afkChannels = ["451371568577249281","808276679389610005"];
...
discordClient.on("voiceStateUpdate", (oldMember, newMember)=> { 
    ...
    if (oldVoice == null) {
        ...
        embed.sendEmbed(discordClient,"808649489307926529","808649811788038165","808649813703917578");
        ...
        //TODO Save jointime in json
        var id = oldMember.member.id;
